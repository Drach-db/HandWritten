...
def run_batch_stage2(
    jsonl_path: str = "cache/batch_stage2.jsonl",
    result_path: str = "cache/results/stage2_results.jsonl",
    completion_window: str = "24h"
):
    """
    Отправляет JSONL файл батчем в OpenAI и сохраняет результаты.
    ...
    logger.info("Запуск batch Stage 2")
